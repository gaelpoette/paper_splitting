...
Here, tuning of the time step for speth (figure \ref{SPETH_exs}). Figure \ref{SGD_exs} is obtained with the same lr as the one for speth of figure \ref{SPETH_exs}. 
