...
\newG{TO DO mettre un algorithme ici? En insistant sur le fait que ça s'applique à tous les optimizers}
...
\newG{En virant la partie sur les $L_i$ et la reduction de memoire, j'ai un peu peur qu'on retombe sur un des algo cité dans l'intro... Il faut que je vérifie. C'est sûr que c'est
nouveau sur toutes les autres adaptation d'optimisers a part GD... Mais dans ce cas il faut insister sur le fait que la nouveauté est de mettre en evidence un pb et de revisiter
les optimisers en questions comme des extensions de speth... j'aimerais pas qu'on nous demande de tous (speth-momentum, speth rms etc.) les tester...}

\section{Numerical results}
\label{num_res}

In this section, we suggest applying the new splitting previously described to the 
