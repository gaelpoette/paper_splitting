...
replaced by a Lyapunov function relative to $F$, see \cite{Lyap_Theory_Bilel,Bilel_thesis}). But the advantage of focusing on a well-balanced adaptative mini-batch version of GD is that
the only hyperparameter to tune is the learning rate (whereas Momentum, RMSProp, Adam etc. also need the tuning of several other coefficients, see \cite{Bilel_thesis}). 
