...
\begin{figure}[!h]
 ...
 \includegraphics[width=0.5\linewidth]{chapitre5_img/16_16_lr1e-4_final_accuracy_hist.png}\\
  \caption{Loss curves (log scale on left picture) across epochs and histograms of the final ($n_{\max}=1500$) accuracy (right picture) on MNIST for (exactly) the same initializations for RRGD, eS-GD, S-Momentum and
