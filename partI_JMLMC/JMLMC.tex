...
this low memory optimiser to outperform eS-GD. But still, it is efficient in the sense that their performances are comparable (which is not the case for RRGD). 
Please note that these runtimes do not correspond to equivalent accuracies, see figures \ref{SGD_exs}-\ref{SPETH_exs}-\ref{SGD_exs_001}-\ref{RR_SPETH_exs} for full comparison of performance.
