...
\label{proof}
\ \\
\textit{Proof for the extended Speth's splitting}
\ \\ \ \\
...
\ \\
\ \\
\textit{Proof for the low memory version of the extended Speth's splitting}
\ \\ \ \\
