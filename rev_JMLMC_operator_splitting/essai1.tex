...
\begin{itemize}
  ...
  \item {\it No benchmarking against variance reduction methods that also operate outside the interpolation regime, such as STORM or RR-SARAH.}
    ...
    \textcolor{blue}{[TODO] We regret that we did not have sufficient time to implement the STORM or RR-SARAH variance reduction methods. We hope this is acceptable, as we have made considerable efforts to address the reviewers' other suggestions and improve the manuscript.}
