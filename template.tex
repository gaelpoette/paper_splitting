...
The table \ref{polyFive_ecreme} presents the number of divergent trajectories on \polyFive as well as the execution time for $28000$ trainings initialized uniformly on $[-5,5]^2$.
...
\subsection{Analytic benchmarks \newG{comme ces bench ne sont pas communement acceptés... Les mettre en annexes? }}
\label{test_analytic}
